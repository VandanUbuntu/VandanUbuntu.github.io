// MADE BY VANDAN
// ECO EEL GAME
// https://github.com/VandanUbuntu/VandanUbuntu.github.io
...
// SETTING UP KEYCODES FOR KEYBOARD KEYSTROKES THAT ARE ENABLED IN THE GAME
Game.Key = {
    BACKSPACE: 8,
    TAB: 9,
    RETURN: 13,
...
// an object (just one key-value pair from it), containing an array, 
// containing at least one object 
// SETTING UP KEYS FOR THE MAIN MENU SCREEN  
    var a = {
        runner: {
            stats: true
        },
...
// DIFFERENT DIFFICULTIES AND THEIR SPEEDS
        difficulties: [{
            label: "Slow",
            dstep: 0.09,
            dscore: 0.75
        ...
        images: [{
            ...
            id: "fruit",
            url: "images/rubbish.png"
        }],

// CREATING A SOUND EFFECTS OBJECT WITH IDS 
        sounds: [{
            id: "highscore_screen",
            name: "sounds/glassshatter",
            formats: ["mp3"],
        }, {
            id: "menu",
            name: "sounds/menu",
    ...
    var b = Class.create({
        ...
        playHighScoreMenuFx: function() {
            if (this.allowFx() && this.isNotMute()) {
                this.sounds.highscore_screen.play()
            }
        },
        ...
        buildMenu: function() {
            ...
            return new Game.Menu(this.dom.overlay, this, {
                ...
                items: [{
                    ...
                    text: "My Goals",
                    title: "Check out why this game was made",
                    action: function() {
                        this.viewCredits()
                    }
                }, ]
    ...
    var d = Class.create({
        ...
        draw: function(j) {
            ...
            while (k = k.next) {
                this.drawPart(j, k, 1 + Math.floor(this.nparts * (q++/this.game.snake.length)),toInt(k.corner))}for(q=0,i=this.game.sparkles.all.length;q<i;q++){m=this.game.sparkles.all[q];j.fillStyle=m.color;j.globalAlpha=m.opacity;for(l=0;l<m.particles.length;l++){o=m.particles[l];j.fillRect((m.pos.x+o.x+0.5)*this.game.dw,(m.pos.y+o.y+0.5)*this.game.dh,o.size*(this.game.dw/
                        2), o.size * (this.game.dh / 2))
                }
            }
